            ...
            { "data": "timeOfDay.partOfDay", "width": "10%" },
            {
                ...
                "render": function (data, type, row, meta) {
                    return `<div class="text-center">
                                <a href="/Students/Update?id=${data}&semesterInstanceId=${row.wishlistDetail.wishlist.semesterInstanceId}" class="btn btn-outline-primary mb-1 rounded" style="cursor:pointer; width: 100px;">
                                    <i class="bi bi-pencil-square"></i> Edit </a>
                                <a href="/Students/Delete?id=${data}&semesterInstanceId=${row.wishlistDetail.wishlist.semesterInstanceId}" class="btn btn-outline-danger mb-1 rounded" style="cursor:pointer; width: 100px;">
